...
var file_api_v1_inference_server_worker_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x1a, 0x65, 0x0a, 0x0b, 0x48, 0x65, 0x61, 0x64,
...
var file_api_v1_inference_server_worker_proto_depIdxs = []int32{
	...
	7,  // 10: llmariner.inference.server.v1.ProcessTasksResponse.new_task:type_name -> llmariner.inference.server.v1.Task
	1,  // 11: llmariner.inference.server.v1.HttpResponse.HeaderEntry.value:type_name -> llmariner.inference.server.v1.HeaderValue
	1,  // 12: llmariner.inference.server.v1.Task.HeaderEntry.value:type_name -> llmariner.inference.server.v1.HeaderValue
	5,  // 13: llmariner.inference.server.v1.InferenceWorkerService.ProcessTasks:input_type -> llmariner.inference.server.v1.ProcessTasksRequest
	8,  // 14: llmariner.inference.server.v1.InferenceWorkerService.ProcessTasks:output_type -> llmariner.inference.server.v1.ProcessTasksResponse
